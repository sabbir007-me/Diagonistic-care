-- Database Schema for Hospital Management & Doctor Booking Platform
...
CREATE TABLE prescriptions (
  ...
  appointment_id VARCHAR(50) REFERENCES appointments(appointment_id) ON DELETE CASCADE,
  patient_id VARCHAR(50) REFERENCES patients(patient_id) ON DELETE CASCADE,
  doctor_id VARCHAR(50) REFERENCES doctors(doctor_id) ON DELETE CASCADE,
  date DATE NOT NULL,
...
CREATE TABLE test_reports (
  ...
  test_id VARCHAR(50) REFERENCES tests(test_id) ON DELETE CASCADE,
  patient_id VARCHAR(50) REFERENCES patients(patient_id) ON DELETE CASCADE,
...
CREATE TABLE payments (
  ...
  payment_method VARCHAR(20) CHECK (payment_method IN ('card', 'upi', 'insurance')),
...
-- Insert Bangladesh Users (Patients, Doctors, Admin)
...
('DOC001', 'D001', 'H001', 'Cardiology', 'MBBS, MD (Cardiology), FCPS', 25, 1500.00, '["9:00 AM", "10:00 AM", "11:00 AM", "2:00 PM", "3:00 PM", "4:00 PM"]'::jsonb, 4.8, NOW()),
('DOC002', 'D002', 'H002', 'Gynecology', 'MBBS, FCPS (Gynecology & Obstetrics)', 15, 2000.00, '["9:30 AM", "11:00 AM", "2:30 PM", "4:00 PM"]'::jsonb, 4.7, NOW()),
('DOC003', 'D003', 'H003', 'Neurology', 'MBBS, MD (Neurology), PhD', 18, 2500.00, '["10:00 AM", "11:30 AM", "3:00 PM", "4:30 PM"]'::jsonb, 4.9, NOW()),
('DOC004', 'D004', 'H004', 'Diabetes & Endocrinology', 'MBBS, FCPS (Medicine), MD (Endocrinology)', 12, 1800.00, '["9:00 AM", "10:30 AM", "2:00 PM", "3:30 PM", "5:00 PM"]'::jsonb, 4.6, NOW()),
('DOC005', 'D005', 'H005', 'Cardiology', 'MBBS, MRCP (UK), MD (Cardiology)', 20, 3000.00, '["10:00 AM", "12:00 PM", "3:00 PM", "5:00 PM"]'::jsonb, 4.9, NOW()),
('DOC006', 'D006', 'H006', 'Pediatrics', 'MBBS, DCH, FCPS (Pediatrics)', 14, 1200.00, '["9:00 AM", "10:00 AM", "11:00 AM", "2:00 PM", "3:00 PM"]'::jsonb, 4.5, NOW()),
('DOC007', 'D007', 'H007', 'Orthopedics', 'MBBS, MS (Orthopedics), FCPS', 16, 1600.00, '["10:00 AM", "11:00 AM", "3:00 PM", "4:00 PM"]'::jsonb, 4.7, NOW()),
('DOC008', 'D008', 'H008', 'Nephrology', 'MBBS, MD (Medicine), MD (Nephrology)', 22, 2200.00, '["9:00 AM", "11:00 AM", "2:00 PM", "4:00 PM"]'::jsonb, 4.8, NOW()),
('DOC009', 'D009', 'H009', 'General Medicine', 'MBBS, FCPS (Medicine)', 10, 1000.00, '["9:00 AM", "10:00 AM", "11:00 AM", "2:00 PM", "3:00 PM", "4:00 PM", "5:00 PM"]'::jsonb, 4.4, NOW()),
('DOC010', 'D010', 'H010', 'Dermatology', 'MBBS, DDV, MD (Dermatology)', 13, 1400.00, '["10:00 AM", "11:30 AM", "2:30 PM", "4:00 PM"]'::jsonb, 4.6, NOW());
...
('A001', 'P001', 'DOC001', 'H001', '2025-12-31', '10:00 AM', 'scheduled', 'in-person', 'Follow-up for blood pressure check', 'paid', NOW()),
('A002', 'P002', 'DOC002', 'H002', '2025-12-31', '11:00 AM', 'scheduled', 'online', 'Regular checkup during pregnancy', 'paid', NOW()),
('A003', 'P003', 'DOC003', 'H003', '2026-01-02', '3:00 PM', 'scheduled', 'in-person', 'Headache and dizziness complaints', 'pending', NOW()),
('A004', 'P004', 'DOC009', 'H009', '2025-12-30', '2:00 PM', 'completed', 'in-person', 'General health checkup', 'paid', NOW()),
('A005', 'P005', 'DOC008', 'H008', '2026-01-03', '11:00 AM', 'scheduled', 'in-person', 'Kidney stone consultation', 'pending', NOW()),
('A006', 'P006', 'DOC004', 'H004', '2026-01-04', '10:30 AM', 'scheduled', 'online', 'Diabetes management consultation', 'paid', NOW()),
('A007', 'P007', 'DOC007', 'H007', '2025-12-28', '3:00 PM', 'completed', 'in-person', 'Joint pain treatment', 'paid', NOW()),
('A008', 'P008', 'DOC003', 'H003', '2026-01-05', '10:00 AM', 'scheduled', 'in-person', 'Migraine treatment', 'pending', NOW());
...
('RX001', 'A004', 'P004', 'DOC009', '2025-12-30', 'Viral fever with body ache', 
...
('RX002', 'A007', 'P007', 'DOC007', '2025-12-28', 'Osteoarthritis of knee joint',
...
('R001', 'T001', 'P001', 'DOC001', '2025-12-25', 
...
('R002', 'T003', 'P001', 'DOC001', '2025-12-25',
...
('R003', 'T007', 'P003', 'DOC001', '2025-12-20',
...
('PAY002', 'A002', 'P002', 2000.00, 'upi', 'completed', 'BKASH20251230002', '2025-12-30 10:30:00', NOW()),
('PAY003', 'A004', 'P004', 1000.00, 'card', 'completed', 'TXN20251230003', '2025-12-30 13:45:00', NOW()),
('PAY004', 'A006', 'P006', 1800.00, 'upi', 'completed', 'NAGAD20251230004', '2025-12-30 15:20:00', NOW()),
('PAY005', 'A007', 'P007', 1600.00, 'card', 'completed', 'TXN20251228001', '2025-12-28 14:30:00', NOW());
